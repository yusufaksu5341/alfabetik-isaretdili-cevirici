...
├── index.html          # Ana HTML dosyası - UI ve DOM yapısı
├── styles.css          # CSS stil tanımlamaları - Görseller ve tasarım
├── script.js           # JavaScript mantık - Tüm işlevler ve AI entegrasyonu
...
- Video kamerası stream'i
- Alfabe grid'i
- Kontrol paneli ve UI öğeleri
- ~150 satır

### styles.css
- Tüm CSS stil tanımlamaları
- Modern tasarım ve animasyonlar
- Responsive layout (820px breakpoint)
...
- Harf tanıma algoritması
- Tutma zamanlayıcısı ve onay mekanizması
- UI güncellemeleri ve state yönetimi
- Sesli okuma (Text-to-Speech)
- Klavye kontrolleri
- ~650 satır, yoğun yorum satırları
